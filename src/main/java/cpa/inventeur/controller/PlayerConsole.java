...
public class PlayerConsole {
    ...
    public PlayerConsole(PlayerColor color) {
     ...
     */
    public boolean send(Inventor inventor, Invention invention) {
     ...
     */
    public List<Inventor> getLibres() {
     ...
     */
    public boolean pickTicket(Invention invention, Ticket ticket) {
